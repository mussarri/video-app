...
const VideoPage = () => {
  ...
  return (
    <div className="flex gap-5">
      <div className="w-full p-1 flex-1 ">
        ...
        <div className="py-4">
          <div className="flex w-full justify-between py-2 items-center pr-2">
            <p className="font-semibold text-lg mt-2 capitalize">{title}</p>
                      ...
                      >
                        ...
                        <div className="flex items-center space-x-2 mt-2">
                          <RadioGroupItem
                            ...
                            id="option-three"
                          />
                          <Label htmlFor="option-three">New</Label>
                          <Input />
                        </div>
                      </RadioGroup>
                    </div>
      ...
      <div className="flex flex-col gap-3 py-1" style={{ minWidth: 300 }}>
        {Array(10)
          .fill(0)
          .map(() => (
            <div className="videocard  w-full flex gap-3 cursor-pointer">
              ...
              <div className="flex flex-col justify-around h-full w-full overflow-hidden">
                <p className="font-semibold text-md">Lorem ipsum dolor sit.</p>
